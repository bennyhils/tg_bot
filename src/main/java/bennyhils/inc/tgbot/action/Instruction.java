...
public class Instruction implements Action {
    ...
    private SendMessage sendInstruction(long chatId, String link) {
        SendMessage sendMessage = new SendMessage(
                ...
                "\n" +
                "2. Откройте <b>Файл для подключения</b>, присланный ботом, в приложении WireGuard. " +
                "\n" +
                "3. Разрешите все доступы, которые просит приложение, это необходимо для работы"
        );
